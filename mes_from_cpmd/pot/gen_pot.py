...
def create_potentials(fn_cube_ref_dens, n_states, fac):   
        ...
        if fac:
            lime.print_states_dict(mom_pol_ar*0.001*fac, cell_data_ref_dens, n_states + 1, 'cartesian-functions-%05d', pure = True, pert = True)
        else:
...
def main():
        ...
        fn_cube_ref_dens = args.path_to_DENSITY
        n_states = args.n 
        fac = args.fac
        create_potentials(fn_cube_ref_dens, n_states, fac)
